    ...
    <div className="w-full lg:min-w-[400px] py-6 sm:py-10 px-4 sm:px-8 xl:px-12 relative bg-fill rounded-sm shadow-dropDown flex flex-col justify-center">
      ...
      <form onSubmit={handleSubmit(onSubmit)} noValidate className="mt-4">
        ...
        <div className="relative">
          <button
            type="submit"
            className="inline-flex items-center justify-center w-full font-nunito px-4 py-2 text-base font-medium leading-6 text-white whitespace-no-wrap bg-orange-500 rounded-sm shadow-sm focus:outline-none focus:ring-2 focus:ring-offset-2 hover:bg-opacity-90"
          >
